...
export const CurriculumMapModal = ({
            ...
            <View style={styles.curriculumModalOverlay}>
                <View style={styles.curriculumModalContent}>
                    ...
                    >
                        <View style={styles.curriculumModalHeaderLeft}>
                            ...
                            <View style={styles.curriculumHeaderTextContainer}>
                                <Text style={styles.curriculumModalTitle}>
                                    Malla Curricular
                                </Text>
                    ...
                    <View style={styles.curriculumImageContainer}>
                        {(() => {
                            const careerCode = extractCareerCode(degree_code);
                            return careerCode && careerImages[careerCode] ? (
                                ...
                                <View style={styles.noImageContainer}>
                                    ...
                                    <Text style={styles.noImageSubtext}>
                                        Esta carrera aún no tiene malla curricular disponible en el
                                        sistema
                                    </Text>
                                    <TouchableOpacity
...
const styles = StyleSheet.create({
    ...
    curriculumModalTitle: {
        fontSize:
            Platform.OS === "android" ? (isTablet ? 18 : 16) : isTablet ? 20 : 18,
        fontWeight: "bold",
        color: "#FFFFFF",
        marginBottom: 2,
    ...
    curriculumModalSubtitle: {
        fontSize:
            Platform.OS === "android" ? (isTablet ? 12 : 11) : isTablet ? 14 : 12,
        color: "#FFFFFF",
        opacity: 0.9,
        fontWeight: "500",
    },
    ...
    noImageSubtext: {
        fontSize:
            Platform.OS === "android" ? (isTablet ? 14 : 13) : isTablet ? 16 : 14,
        color: "#6b7280",
        textAlign: "center",

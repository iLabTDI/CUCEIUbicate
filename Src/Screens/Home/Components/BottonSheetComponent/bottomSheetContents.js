...
export const bottomSheetContents = {
  "Modulo A": {
    ...
    "photo-path": [
      require("./Modulos_Fotos/Modulo A/IMG_9770.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_9772.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_9773.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_9775.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_5.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_6.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_7.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_8.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_9.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_10.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_11.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_12.jpg"),
      require("./Modulos_Fotos/Modulo A/IMG_13.jpg"),
    ],
    description:
